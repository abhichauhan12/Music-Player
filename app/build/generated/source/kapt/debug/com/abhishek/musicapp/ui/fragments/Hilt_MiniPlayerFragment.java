 ...
 */
public abstract class Hilt_MiniPlayerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MiniPlayerFragment() {
    super();
  }

  Hilt_MiniPlayerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MiniPlayerFragment_GeneratedInjector) this.generatedComponent()).injectMiniPlayerFragment(UnsafeCasts.<MiniPlayerFragment>unsafeCast(this));
    }
  }
