 ...
 */
public abstract class Hilt_ForYouFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForYouFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForYouFragment_GeneratedInjector) this.generatedComponent()).injectForYouFragment(UnsafeCasts.<ForYouFragment>unsafeCast(this));
    }
  }
