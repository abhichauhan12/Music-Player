 ...
 */
public abstract class Hilt_SongFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongFragment_GeneratedInjector) this.generatedComponent()).injectSongFragment(UnsafeCasts.<SongFragment>unsafeCast(this));
    }
  }
