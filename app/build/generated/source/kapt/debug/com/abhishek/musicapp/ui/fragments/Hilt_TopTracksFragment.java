 ...
 */
public abstract class Hilt_TopTracksFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TopTracksFragment() {
    super();
  }

  Hilt_TopTracksFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TopTracksFragment_GeneratedInjector) this.generatedComponent()).injectTopTracksFragment(UnsafeCasts.<TopTracksFragment>unsafeCast(this));
    }
  }
